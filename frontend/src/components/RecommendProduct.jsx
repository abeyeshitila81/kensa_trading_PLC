...
export default function RecommendProduct({ category, heading }) {
      ...
      <h1> {heading}</h1>
{
    ...
    :(
    <div className="container w-[97%] p-2 mx-auto bg-white grid grid-cols-3 justify-between items-center overflow-scroll scrollbar-none transition-all gap-2" ref={scrollElement}>

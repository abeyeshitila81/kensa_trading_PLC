...
export default function SearchProduct({ products, loading }) {
      ...
      <h1> </h1>
{
    ...
    :(
    <div className="container w-[97%] p-2 mx-auto bg-white grid grid-cols-3 gap-6 justify-between items-center overflow-scroll scrollbar-none transition-all " >
        {products  ? (
